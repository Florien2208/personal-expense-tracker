      ...
      <nav className="relative z-50 px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center space-x-4">
            ...
            <button className="border border-slate-600 px-4 py-2 rounded-lg font-semibold hover:bg-slate-800 transition-all duration-300">
              Sign In
            </button>
          </div>
        </div>
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0">
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-6 lg:p-8">
              ...
              <div className="space-y-4 lg:space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-purple-500 to-cyan-500 px-6 py-3 rounded-xl font-semibold text-base lg:text-lg hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
                >
                  Create Account
